...
import functools
from .block import ResnetBlock, ResnetBlock3d
...
class DefinedDiscriminator(nn.Module):
    def __init__(self, input_nc=1, output_nc=64, use_sigmoid=False):
        ...
        self.inconv = nn.Sequential(*[nn.Conv3d(input_nc, 32, kernel_size=3, stride=2, padding=1), nn.InstanceNorm3d(32), nn.LeakyReLU(0.2, True)])
